...
O trabalho possui, além da Introdução, os capítulos de Fundamentação e Estudo Investigativo. Na fundamentação é discorrido sobre todos os tópicos necessários para o entendimento do trabalho e os artigos selecionados para o estudo. No último capítulo, é explicada a metodologia a ser aplicada, desde a coleta das mangas até a construção dos modelos preditivos, assim como o cronograma para o TCC II.
