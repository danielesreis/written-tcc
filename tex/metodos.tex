...
\centering
    ...
    \subcaptionbox{(a)}{\includegraphics[scale=0.109]{img/palmer}}
    \subcaptionbox{(b)}{\includegraphics[scale=0.039]{img/tommy}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
\begin{figure}[!htb]
\centering
    \caption{\label{fig:prep_tommy} Antes e depois do pré-processamento (a) Imagem original (b) Imagem resultante após utilização de técnicas de pré-processamento.}
    \subcaptionbox{(a)}{\includegraphics[scale=0.035]{img/sem_processamento.JPG}}
    \subcaptionbox{(b)}{\includegraphics[scale=0.062]{img/processada.JPG}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
