...
%--------------------------------------------------------------------------------------
\chapter{Material e Métodos} \label{ch:MM} %Uma label é como você referencia uma seção no texto com a tag \ref{}
...
Foram tiradas fotos de 750 mangas, e, como os dois lados de cada amostra foram fotografados, no total obtiveram-se 1500 imagens. Para a Palmer, foram fotografadas 600 mangas até o dia da colheita e 150 após ela. A Figura \ref{img:palmer_tommy} exibe fotos da manga Palmer em diferentes estádios.
...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer1}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer2}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer3}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer4}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer5}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer6}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer7}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer8}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer9}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer10}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer11}}
    \subcaptionbox{}{\includegraphics[scale=0.02]{img/palmer12}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.025]{img/sem_processamento.jpg}}
    \subcaptionbox{}{\includegraphics[scale=0.025]{img/median_filtered.jpg}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.025]{img/segmented.jpg}}
    \subcaptionbox{}{\includegraphics[scale=0.025]{img/opened.jpg}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.025]{img/thresholded.jpg}}
    \subcaptionbox{}{\includegraphics[scale=0.025]{img/closed.jpg}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
% \begin{figure}[H]
% \centering
%     \caption{\label{fig:prep} Imagem pré-processada resultante.
%     \includegraphics[scale=0.035]{img/cut.jpg}
%     \legend{\textbf{Fonte: } (Autor, 2019).}
% \end{figure}
