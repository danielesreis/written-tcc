...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.03]{img/sem_processamento.jpg}}
    \subcaptionbox{}{\includegraphics[scale=0.03]{img/median_filtered.jpg}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.03]{img/segmented.jpg}}
    \subcaptionbox{}{\includegraphics[scale=0.03]{img/opened.jpg}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
...
\centering
    ...
    \subcaptionbox{}{\includegraphics[scale=0.03]{img/thresholded.jpg}}
    \subcaptionbox{}{\includegraphics[scale=0.03]{img/closed.jpg}}
    \legend{\textbf{Fonte: } (Autor, 2019).}
\end{figure}
